...
static safety_config hyundai_init(uint16_t param) {
  ...
  static const CanMsg HYUNDAI_CAN_CANFD_BLENDED_LONG_TX_MSGS[] = {
    ...
    {0x420, 2, 8, .check_relay = false, .disable_static_blocking = true},   /* SCC11 Bus 0       */
    {0x421, 2, 8, .check_relay = false, .disable_static_blocking = true},   /* SCC12 Bus 0       */
    {0x389, 2, 8, .check_relay = false, .disable_static_blocking = true},   /* SCC14 Bus 0       */
    {0x38D, 0, 8, .check_relay = false}, // FCA11 Bus 0
    {0x7D0, 0, 8, .check_relay = false}, // radar UDS TX addr Bus 0 (for radar disable)
